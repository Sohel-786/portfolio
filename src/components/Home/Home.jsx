  ...
  return (
    <section className="lg:flex-row flex flex-col lg:gap-0 gap-12 justify-center items-center lg:h-[550px] h-[800px]">
      ...
      <div className="lg:w-5/12 lg:h-full w-full h-2/5 lg:mt-0 mt-6 flex justify-center items-center overflow-hidden">
        ...
        >
          <img className="w-full h-full" fetchpriority="high" loading="eager" rel='preload' src="https://rukminim2.flixcart.com/image/850/1000/kvlaaa80/poster/c/5/e/medium-anime-boy-cool-anime-well-made-matte-finish-poster-original-imag8gayfhwhyuab.jpeg" alt="myImage" />
        </div>
      </div>
    </section>
  );
